...
<tr valign="top">
<td><input type="text" name="search_name" value="<?php if (isset($search_string)) echo $search_string;?>" class="ui-corner-left" /></td> 
...
<table border="0" cellpadding="0" cellspacing="0">
<tr valign="top">
<td><input type="text" name="search_sms" value="<?php if (isset($search_string)) echo $search_string;?>" class="ui-corner-left" /></td> 
