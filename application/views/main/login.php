	...
	<center>
		...
		<div id="login_container">
			...
			<table id="login" cellpadding="3" cellspacing="2" border="0" class="rounded">
				<tr>
					<td><i>Please enter your username and password</i></td>
				</tr>
				<tr>
					<td><label>Username</label><input type="text" name="username" id="username" style="width:95%" /></td>
				</tr>
				<tr>
					<td><label>Password</label><input type="password" name="password" style="width:95%" /></td>
				</tr>
				<tr>
					<td>
						...
						<div align="center" style="float: right; padding-right: 3px"><input type="submit" id="submit" value="Login" /></div>
					</td>
				</tr>
				<tr>
					<td align="center"><a style="color: #fff" href="<?php echo site_url('login/forgot_password');?>">Forgot your password?</a></td>
				</tr>
			</table>
			<?php echo form_close();?>
		</div>
